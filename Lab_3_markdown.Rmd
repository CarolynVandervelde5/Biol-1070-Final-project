...
This is the final project for Biol*4510, looking at SNPS related to human population density. This analysis looks at the Great Gray Owl using data from a published paper.  
...
"best" k from the AIC appears to be 4 (same as paper)
